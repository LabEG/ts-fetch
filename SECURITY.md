...
We actively support the following versions of `@labeg/tfetch` with security updates:
...
We take the security of `@labeg/tfetch` seriously. If you discover a security vulnerability, please follow these steps:

### How to Report

1. **DO NOT** open a public GitHub issue for security vulnerabilities
2. Send a detailed report to the repository maintainer via:
   - GitHub Security Advisory: [Report a vulnerability](https://github.com/LabEG/ts-fetch/security/advisories/new)
   - Email: Create an issue in the [issue tracker](https://github.com/LabEG/ts-fetch/issues) marked as **Security** (if no sensitive details need to be shared)
...
- **Version**: The version of `@labeg/tfetch` affected
...
This package relies on ts-serializable and fetch API. We:
...
As a data fetching and serialization library, `@labeg/tfetch`:

- **Executes network requests** - ensure URLs are from trusted sources
- **Handles user data** - be cautious with sensitive information
- **Performs serialization/deserialization** - validate data from untrusted sources
- **May be used in production** - follow security best practices
...
- Open a [GitHub Security Advisory](https://github.com/LabEG/ts-fetch/security/advisories/new)
- Create an issue at: <https://github.com/LabEG/ts-fetch/issues>

---

Thank you for helping keep `@labeg/tfetch` and its users safe!
