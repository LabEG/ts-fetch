...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/ts-fetch.git
cd ts-fetch
...
```bash
feat: add support for new HTTP method
fix: correct serialization issue with nested objects
...
Thank you for contributing to @labeg/tfetch! 🎉
